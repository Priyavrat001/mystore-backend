...
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (nodeCache.has(key))
        ...
        const [thisMonthProducts, lastMonthProducts, thisMonthUsers, lastMonthUsers, thisMonthOrders, lastMonthOrders, productsCount, usersCount, allOrders, lastSixMonthOrders, categories, femaleUsers, letestTransactions] = await Promise.all([
...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (nodeCache.has(key))
        ...
        const [processingOrder, shippedOrder, deliverdOrder, categories, productsCount, productOutOfStock, allOrders, allUsers, adminUser, coustomerUser,] = await Promise.all([
