...
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (nodeCache.has("admin-stats"))
        ...
        const [thisMonthProducts, lastMonthProducts, thisMonthUsers, lastMonthUsers, thisMonthOrders, lastMonthOrders, productsCount, usersCount, allOrders, lastSixMonthOrders, categories, femaleUsers] = await Promise.all([
